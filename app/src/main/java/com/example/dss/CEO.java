...
public class CEO extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button createIdButton = findViewById(R.id.createid);
        Button employeeDetailsButton = findViewById(R.id.employeedetails);
        Button leaveRequestsButton = findViewById(R.id.leaverequests);
        Button leaveHistoryButton = findViewById(R.id.leavehistory);

        createIdButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CEO.this, CreateIdActivity.class);
        ...
        employeeDetailsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CEO.this, EmpdetailsActivity.class);
                startActivity(intent);
            }
        });

        leaveRequestsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CEO.this, LeaveRequestsActivity.class);
                startActivity(intent);
            }
        });

        leaveHistoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CEO.this, LeaveHistoryActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void logout() {
        ...
        Intent intent = new Intent(CEO.this, LoginActivity.class);
        startActivity(intent);
